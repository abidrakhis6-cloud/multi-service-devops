...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'✓ {Store.objects.count()} magasins créés'))
        self.stdout.write(self.style.SUCCESS(f'✓ {Product.objects.count()} produits créés'))
        self.stdout.write(self.style.SUCCESS(f'✓ {Driver.objects.count()} livreurs créés'))
